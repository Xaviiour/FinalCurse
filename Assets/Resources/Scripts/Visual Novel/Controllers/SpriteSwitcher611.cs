...
public class SpriteSwitcher611 : MonoBehaviour
{
    ...
    public IEnumerator SwitchBG()
    {
        ...
        if (scene.name == "Scene 6-11")
        {
            cont1.runtimeAnimatorController = Resources.Load("Animations/Backgrounds/City School") as RuntimeAnimatorController;
        }
        else
